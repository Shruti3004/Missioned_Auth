            ...
            <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-12 form-center">
                    <div className="sign-in-form p-4">
                        ...
                        <h4 className="text-center text-light-orange font-weight-bold">Sign In</h4>
                        <form>
                            ...
                            <div className="input-group mt-4 mb-1">
                                ...
                                <div className="input-group-prepend">
                                    <span className="input-group-text background-white text-light-orange px-1" onClick={showHide}>{passwordType.type === 'password' ? <i className="fas fa-eye text-pink"/> : <i className="fas fa-eye-slash text-light-orange"/> } </span>
                                </div>
                            </div>
                            ...
                            <ButtonContainer className="background-light-orange w-100 mt-5 text-white" cartBtn onClick={handleSubmit}>
                                <input type="submit" value="Login" className="text-white btn"/>
                            </ButtonContainer>                            
                            <Link to="/register">
                                <ButtonContainer className="background-light-orange w-100 mt-2 text-white" cartBtn>                                    
